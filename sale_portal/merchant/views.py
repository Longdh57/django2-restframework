...
def render_excel(request=None, return_url=True):
    ...
    worksheet.write('G1', 'SL Ter', merge_format)
    worksheet.write('H1', 'SLGD hôm qua', merge_format)
    worksheet.write('I1', 'SLGD K1', merge_format)
    worksheet.write('J1', 'SLGD K2', merge_format)
    worksheet.write('K1', 'SLGD K3', merge_format)
    worksheet.write('L1', 'SLGD K4', merge_format)
    worksheet.write('M1', 'Tình trạng', merge_format)
