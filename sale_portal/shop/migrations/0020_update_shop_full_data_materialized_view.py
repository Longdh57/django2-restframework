...
class Migration(migrations.Migration):
    dependencies = [
        ('shop', '0019_update_shop_full_data_materialized_view'),
    ]
        ...
        migrations.RunSQL(
            ...
            from shop sh
                     ...
                     left join (select shop_id,
                                       report_date,
                                       number_of_tran_acm,
                                       number_of_tran_last_m,
                                       number_of_tran,
                                       number_of_tran_w_1_7,
                                       number_of_tran_w_8_14,
                                       number_of_tran_w_15_21,
                                       number_of_tran_w_22_end,
                                       voucher_code_list
                                from shop_cube
                                group by shop_id, report_date, number_of_tran_acm, number_of_tran_last_m, number_of_tran, number_of_tran_w_1_7, number_of_tran_w_8_14,
                                         number_of_tran_w_15_21, number_of_tran_w_22_end, voucher_code_list) scube
                               on sh.id = scube.shop_id
